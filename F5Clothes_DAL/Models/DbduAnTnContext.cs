...
<<<<<<< HEAD
        => optionsBuilder.UseSqlServer("Server=LAPTOP-7HORMRAF\\SQLEXPRESS01;Database=DBDuAnTN;TrustServerCertificate=True;Trusted_Connection=True;");
=======
        => optionsBuilder.UseSqlServer("Server=DESKTOP-77H263D\\SQLEXPRESS;Database=DBDuAnTN;TrustServerCertificate=True;Trusted_Connection=True;");
>>>>>>> HaThanhThanh
